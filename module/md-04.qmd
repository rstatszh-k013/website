...
session_date <- vars$`md-04`$date |> as.Date()
...
[Zeige Folien im Vollbildmodus an](../folien/md-04-daten-management.html) | [Download slides as PDF]({{< var course.github-org >}}website/raw/main/folien/md-04-daten-management.pdf)
