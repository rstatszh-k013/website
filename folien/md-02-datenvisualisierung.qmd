...
Wichtige Hinweise wie ihr eure R-Installation auf dem DAP konfigurieren könnt, findet ihr auf [zHub](https://ktzuerich.sharepoint.com/sites/zh-informatik/SitePages/Datenanalyse-mit-R---R-Studio.aspx). Beachtet insbesondere dioe "Best practices". 
:::
:::
...
-   Abgabedatum: [{{< var md-02.homework-due >}}]{.highlight-yellow}
