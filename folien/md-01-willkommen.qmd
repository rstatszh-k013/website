...
# Willkommen! {{< fa hand >}} {background-color="#4C326A"}
...
-   Umweltingenieur {{< fa hammer >}}
-   Forscher im Ruhestand {{< fa bed >}}
...
## Ihr seid dran: md-01-uebungen {.smaller}

::: task
1. Öffne [posit.cloud/spaces/{{< var course.posit-cloud-space-id >}}]({{< var course.posit-cloud-space >}}) in deinem Browser.
2. Falls du dich nicht im {{< var course.code >}} Arbeitsbereich befindest, öffne diesen.
...
8. Führe einen einzelnen Code-Chunk aus, indem du auf den [grünen Pfeil]{.highlight-yellow} (▶) oben rechts im Chunk klickst. Was passiert? Wo erscheint die Ausgabe?
9. Vergleiche die drei `filter(year == 2007)` Code-Chunks und beobachte: (1) Ausgabe in der Konsole, (2) Ausgabe als formatierte Tabelle mit `knitr::kable()`, (3) Zuweisung an ein Objekt (keine sichtbare Ausgabe, aber neues Objekt im Environment).
10. Untersuche die weiteren Komponenten des Dokuments und führe eine eigene Aktualisierung durch und rendere erneut.
11. Besprich deine Notizen über die vorgenommenen Aktualisierungen und Beobachtungen mit deinen Raumpartner:innen.
:::
...
## Mit einer Installation ist alles enthalten {.smaller}
...
-   GitHub ist eine Hosting-Plattform für Versionskontrolle mit Git

-   2008 gestartet, 2018 von Microsoft für US\$ 7.5 Milliarden übernommen

-

    > 180 Millionen Nutzer:innen (2025) ([Octoverse, 2025](https://github.blog/news-insights/octoverse/octoverse-a-new-developer-joins-github-every-second-as-ai-leads-typescript-to-1/))

-   Social Media für Softwareentwickler:innen
:::
:::
...
Folien als [PDF auf GitHub]({{< var course.github-org >}}website/raw/main/folien/md-01-willkommen.pdf)
