...
4.  Suche im Dateimanager im Fenster unten rechts die Datei [`02-iteration-ihr.qmd`]{.highlight-yellow} und klicke darauf, um sie im Fenster oben links zu öffnen.
...
::: learn-more
[{{< var course.site-short >}}/module/md-06.html](https://{{< var course.site-short >}}/module/md-06.html)
:::
...
Access slides als [PDF auf GitHub]({{< var course.github-org >}}website/raw/main/folien/md-06-daten-typen.pdf)
