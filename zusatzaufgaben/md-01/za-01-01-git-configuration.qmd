...
## Pause eingelegt? So findest du dein Projekt wieder
...
1. Öffne den {{< var course.code >}} Arbeitsbereich (Workspace) auf [{{< var course.posit-cloud-space >}}]({{< var course.posit-cloud-space >}}) erneut.
