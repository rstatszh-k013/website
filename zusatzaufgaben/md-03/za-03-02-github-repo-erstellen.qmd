...
::: callout-note
## Hinweis: Dateigrösse beachten
Beachte, dass Dateien grösser als 50 MB nicht auf GitHub gepusht werden können. Wähle deshalb für diese Aufgabe einen kleineren Datensatz aus. In Modul 4 lernen wir dann, wie auch diese grossen Dateien direkt aus dem Internet gelesen werden können, ohne sie lokal zu speichern.
:::
