...
1. Überprüfe ob dein Projekt den gleichen Aufbau hat wie das [Projekt von Rainbow Train: github.com/{{< var course.code >}}/projekt-rainbow-train]({{< var course.github-org >}}projekt-rainbow-train)
...
10. Gib [deinen GitHub Personal Access Token (PAT)]{.highlight-yellow} im Feld ["Personal access token for 'https://...'"]{.highlight-yellow} ein.
